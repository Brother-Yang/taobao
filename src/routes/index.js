...
import Details from '@v/details/Index.vue'
...
const routes = [
  ...
  {
    ...p('info'),
    component:() => import('@v/info/Index')
  },
  {
    ...p('shopcar'),
    component:() => import('@v/shoppingCar/Index')
  },
  {
    ...p('tao'),
    component:() => import('@v/tao/Index')
  },
  {
    path: '/index/detail/:id',
    name: 'detail',
    component: Details        // 设置路由缓存
  }
]
